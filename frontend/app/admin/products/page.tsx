...
// Tipagem da resposta paginada do backend
...
export default function ProductsPage() {
  ...
  // Não precisamos mais do filteredProducts, pois o backend já filtra
  // Mas podemos manter a lógica local caso queira fallback – vamos usar direto o estado `products`
  ...
  return (
    <div>
      ...
      <input
        ...
        className="mb-4 w-full max-w-md rounded border p-2 text-gray-800"
      />
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded border px-3 py-1 text-gray-700 hover:bg-gray-100 disabled:opacity-50"
              >
                Anterior
              </button>
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
            ...
            <form onSubmit={handleCreate} className="flex flex-col gap-3">
              <input
                ...
                className="rounded border p-2 text-gray-800"
              />
              <input
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 rounded border px-4 py-2 text-gray-700 hover:bg-gray-100"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={creating}
                  className="flex-1 rounded bg-[#F47920] px-4 py-2 font-semibold text-white hover:bg-[#d4661a] disabled:opacity-50"
                >
            ...
            <form onSubmit={handleEdit} className="flex flex-col gap-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  disabled={editing}
                  className="flex-1 rounded bg-[#1B2A4A] px-4 py-2 font-semibold text-white hover:bg-[#243660] disabled:opacity-50"
                >
